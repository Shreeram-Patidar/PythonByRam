...
while True:
    ...
    print("5. Students in Both Courses")
    print("6. Students Only in Python")
    print("7. Students Only in Java")
    print("8. Check Enrollment in Python")
